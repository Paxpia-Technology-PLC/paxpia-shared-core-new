...
// • `type:'overlay' | 'doc'` → a child `View` hosting the JS overlay renderer
//   (poll/quiz/doc), positioned by the same normalized→px math.
...
export type LayoutItemType = 'camera' | 'screen' | 'overlay' | 'doc';
